...
#define MERR_DECRYPTION					(MERR_BASIC_BASE+13)
#define MERR_TIMESTAMP_DISCONTINUE		(MERR_BASIC_BASE+14)
#define MERR_PARTIAL_MSG				(MERR_BASIC_BASE+15)
#define MERR_STREAM_CHECK				(MERR_BASIC_BASE+16)
...
#define MERR_SOCKET_HOST_TIMEOUT		(MERR_NET_BASE+15)
#define MERR_SOCKET_WOULDBLOCK		    (MERR_NET_BASE+14)
#define MERR_SOCKET_RECV_TIMEOUT		(MERR_NET_BASE+13)
...
#define	MERR_HTTP_RESPONSE_601			(MERR_HTTP_REQUEST_FAIL+601)
#define	MERR_HTTP_RESPONSE_602			(MERR_HTTP_REQUEST_FAIL+602)

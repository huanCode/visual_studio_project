...
static const struct URLProtocol *url_find_protocol(const char *filename)
{
	...
	//ffurl_get_protocols 查找url_protocols数组中符合参数条件的URLProtocol，
	//whitelist = blacklist = NULL ,表示默认全都返回
	//whitelist 表示查找url_protocols中符合条件的URLProtocol，blacklist 表示不要的URLProtocol
